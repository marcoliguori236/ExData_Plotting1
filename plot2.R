...
#My local language is spanish so this command is to be run if your computers language is not english
Sys.setlocale("LC_TIME", "English")

with(subset, plot(date.time, Global_active_power, type = "l", xlab = "", ylab="Global Active Power(kilowatts)"))
